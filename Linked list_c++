...
int Bag::min(){
	...
	if(it->next==NULL){
		cout<<"The minimum of this Bag list is "<< mini<<endl;
	}
	else{
		com=it->next;
...
int Bag::avg(){
	...
	if(front->next==NULL){
		cout<<"The average of this Bag list is "<< sum <<endl;
	}
	else{
		com=front->next;
		while(com !=NULL){
    	...
    	aver=sum/size;
		cout<<"The average of this Bag list is "<< aver <<endl;
	}
}
...
int Bag::max(){
	...
	if(it->next==NULL){
		cout<<"The maximum of this Bag list is "<< maxi<<endl;
	}
	else{
		com=it->next;
